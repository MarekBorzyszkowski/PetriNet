...
public class Inhibitor<PL extends Place> extends Edge<PL>{
	public Inhibitor(int valueAttribute, PL place, ITransaction<PL> transaction, Direction direction) {
		super(valueAttribute, place, transaction, direction);
	}

	public Inhibitor(PL place, ITransaction<PL> transaction, Direction direction) {
