...
public abstract class PetriNet<TR extends ITransaction> {
	...
	public Regular addRegular(int valueAttribute, Place place, ITransaction transaction, Direction direction){
		Regular r = new Regular(valueAttribute, place, transaction, direction);
		regulars.add(r);
		return r;
	}

	public Inhibitor addInhibitor(int valueAttribute, Place place, ITransaction transaction, Direction direction){
